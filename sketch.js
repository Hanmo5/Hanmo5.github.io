...
// Load the image.
function preload() {
    img7 = loadImage('/1_7.png');
    img6 = loadImage('/1_6.png');
    img5 = loadImage('/1_5.png');
    img4 = loadImage('/1_4.png');
    img3 = loadImage('/1_3.png');
    img2 = loadImage('/1_2.png');
    img1 = loadImage('/1_1.png');
}
function setup() {
...
function draw() {
  ...
  image(img3, mouseX / 8 +500, 325, 1200, 650);
  image(img4, mouseX / 6 +400, 325, 1200, 650);
  ...
  image(img7, mouseX / 3 +400, 325, 2500, 1050);
