...
function preload() {
    ...
    img8 = loadImage('/4_8.png');
    img7 = loadImage('/4_7.png');
    img6 = loadImage('/4_6.png');
    img5 = loadImage('/4_5.png');
    img4 = loadImage('/4_4.png');
    img3 = loadImage('/4_3.png');
    img2 = loadImage('/4_2.png');
    img1 = loadImage('/4_1.png');
}
function setup() {
...
function draw() {
  ...
  blendMode(DODGE);
  image(img4, mouseX / 4 +600, 325, 1200, 650);
  blendMode(OVERLAY);
  image(img5, mouseX / 15 +600, 325, 1200, 650);
  blendMode(NORMAL);
  image(img6, mouseX / 6 +600, 325, 1200, 650);
  image(img7, mouseX / 3 +300, 325, 1800, 975);
  image(img8, mouseX / 2 +250, 425, 800, 433);
